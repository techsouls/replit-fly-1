      ...
      <div className="container mx-auto px-4 md:px-6 flex items-center justify-between">
        <Link href="/">
          <div className="flex items-center gap-2 cursor-pointer group">
            ...
            <span className={`text-xl md:text-2xl font-bold font-display tracking-tight ${scrolled ? 'text-primary' : 'text-primary'}`}>
              TravelTogether
            </span>
          </div>
        </Link>
        ...
        <div className="flex items-center gap-2 md:gap-6">
          <Link href="/contact">
            <span className={`text-sm md:text-base font-medium hover:text-secondary transition-colors cursor-pointer ${location === '/contact' ? 'text-secondary' : 'text-foreground/80'}`}>
              Contact
            </span>
          </Link>
          <Button 
