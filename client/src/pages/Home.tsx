          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-center">
            ...
            >
              ...
              <p className="text-xl md:text-2xl text-muted-foreground mb-8 leading-relaxed">
                Connect with caring co-travelers who help you navigate airports,
                carry luggage, and provide companionship on your journey.
              </p>
            ...
            >
              <div className="relative rounded-[2rem] overflow-hidden shadow-2xl shadow-blue-900/10 border-[8px] border-white">
                ...
                <img
                  ...
                  src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTv45NXTFcjYWp9A2WCVKWRFdN700o0MjUwgQ&s"
                ...
                <div className="absolute bottom-8 left-8 bg-white/95 backdrop-blur-md p-4 rounded-2xl shadow-lg max-w-xs border border-white/50 hidden md:block">
                  ...
                  <p className="text-sm text-foreground/80 italic">
                    "Sarah helped me with my bags and we chatted the whole way.
                    It felt like traveling with a granddaughter."
                  </p>
                </div>
              </div>
      ...
      <section className="py-20 bg-white" id="mission">
        <div className="container mx-auto px-4 text-center max-w-3xl">
          ...
          <h2 className="text-3xl md:text-5xl font-bold mb-8">
            Connecting Generations of Travelers
          </h2>
          <p className="text-xl text-muted-foreground leading-relaxed">
            We believe that travel should be accessible and joyful at any age.
            By connecting elderly travelers who need a little extra help with
            younger, capable co-travelers, we create journeys filled with
            support, gratitude, and meaningful connection.
          </p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground">
              Three easy steps to your best travel experience yet.
            </p>
          </div>
          ...
          >
            ...
            <motion.div variants={itemVariants} className="text-center">
              ...
              <p className="text-muted-foreground px-4">
                Create a profile and find a verified travel companion on your
                specific flight.
              </p>
            </motion.div>
            ...
            <motion.div variants={itemVariants} className="text-center">
              ...
              <p className="text-muted-foreground px-4">
                Chat securely beforehand and meet at the airport departure gate.
              </p>
            </motion.div>
            ...
            <motion.div variants={itemVariants} className="text-center">
              ...
              <p className="text-muted-foreground px-4">
                Enjoy the journey with help for bags and navigation, arriving
                with a smile.
              </p>
            </motion.div>
          </motion.div>
              ...
              <ul className="space-y-4">
                {[
                  ...
                  <li key={i} className="flex items-start gap-3">
                    <div className="mt-1 min-w-5 h-5 rounded-full bg-blue-500/10 flex items-center justify-center text-primary text-xs">
                      ✓
                    </div>
            ...
            <div className="p-10 md:p-16 bg-primary text-white flex flex-col justify-center">
              ...
              <ul className="space-y-4">
                {[
                  ...
                  <li key={i} className="flex items-start gap-3">
                    <div className="mt-1 min-w-5 h-5 rounded-full bg-white/20 flex items-center justify-center text-secondary text-xs">
                      ✓
                    </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card className="border-none shadow-lg hover:shadow-xl transition-all duration-300">
              <CardContent className="p-8">
                ...
                <p className="text-muted-foreground mb-6">
                  "My mom was traveling alone for the first time in years.
                  Knowing John was there to help her with her bag gave our whole
            ...
            <Card className="border-none shadow-lg hover:shadow-xl transition-all duration-300 md:-translate-y-4">
              <CardContent className="p-8">
                ...
                <p className="text-muted-foreground mb-6">
                  "I fly this route every month for work. Helping Arthur find
                  his gate didn't cost me any time, but his stories were the
            ...
            <Card className="border-none shadow-lg hover:shadow-xl transition-all duration-300">
              <CardContent className="p-8">
                ...
                <p className="text-muted-foreground mb-6">
                  "The airport is so big now, I get confused. Having a young
                  person walk with me made me feel safe. Thank you Fly
                  Companion."
                </p>
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-full bg-gray-200 overflow-hidden">
                    <div className="w-full h-full bg-purple-100 flex items-center justify-center text-purple-700 font-bold">
                      E
                    </div>
                  </div>
                  <div>
      ...
      <section id="join-waitlist" className="py-24 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 max-w-2xl text-center">
          ...
          <p className="text-xl text-muted-foreground mb-10">
            We are launching soon in select cities. Sign up to be notified when
            we arrive at your airport.
          </p>
            ...
            <CardContent className="p-8 md:p-10">
              ...
              >
                <div className="space-y-4">
                  ...
                  <RadioGroup
                    onValueChange={(val) =>
                      setValue("role", val as "traveler" | "helper" | "both")
                    }
                    defaultValue="both"
